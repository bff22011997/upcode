...
#define COLOR_BORDER [UIColor \
colorWithRed:((float)((0x00ff00 & 0xFF0000) >> 16))/255.0 \
green:((float)((0x00ff00 & 0xFF00) >> 8))/255.0 \
blue:((float)(0x00ff00 & 0xFF))/255.0 alpha:1.0]

#define COLOR_BORDER_UNFILL [UIColor \
colorWithRed:((float)((0xb6b6b6 & 0xFF0000) >> 16))/255.0 \
green:((float)((0xb6b6b6 & 0xFF00) >> 8))/255.0 \
blue:((float)(0xb6b6b6 & 0xFF))/255.0 alpha:1.0]
...
- (void)setDefaults
{
    ...
    //self.unfillColor                    = COLOR_BORDER_UNFILL;
    self.unfillColor                    = [UIColor blueColor];
    self.borderColorForFilledArc        = [UIColor blackColor];
    self.borderColorForUnfilledArc      = [UIColor clearColor];
    self.borderPercentageForFilledArc   = 0;
    self.borderPercentageForUnfilledArc = 0;
   ...
   // self.gradientColor1                 = [UIColor yellowColor];
...
//        self.textLabel.font = [self.textLabel.font fontWithSize:self.centerView.frame.size.width];
        self.textLabel.font = [self.textLabel.font fontWithSize:35];
    }
